...
#define STRING_CONFIG_H_AUTHOR "(Royston)" // Who made the changes.
...
#define DEFAULT_Ki 13.91
#define DEFAULT_Kd 88.24
#endif // PIDTEMP
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 8000, 221.2}  // default steps per unit for Ultimaker
